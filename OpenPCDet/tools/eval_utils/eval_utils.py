...
def eval_one_epoch(cfg, args, model, dataloader, epoch_id, logger, dist_test=False, result_dir=None):
    ...
    # PosixPath('/data/lianghao/expriment/Openpcdet_pointpillar/eval/epoch_300/val/default/final_result/data')
    ...
    class_names = dataset.class_names # ['bus', 'car', 'bicycle', 'pedestrian', 'tricycle', 'semitrailer', 'truck']
    det_annos = []

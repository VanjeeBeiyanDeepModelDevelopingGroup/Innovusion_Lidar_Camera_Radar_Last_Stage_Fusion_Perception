...
def do_eval(gt_annos, # 631
    ...
    计算评价指标
    Args:
        gt_annos:631帧的测试点云标注字典,包括['name', 'alpha', 'dimensions', 'location', 'index', 'gt_boxes_lidar']
        dt_annos:631帧的测试点云预测字典,包括['name', 'truncated', 'occluded', 'alpha', 'bbox', 'dimensions', 
                                                        'location', 'rotation_y', 'score', 'boxes_lidar', 'frame_id']
        current_classes:[2, 0, 1, 4, 3, 5, 6]
        min_overlaps:(2,3,3)
        compute_aos:True
        PR_detail_dict:None
    """
